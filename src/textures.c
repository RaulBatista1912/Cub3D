...
{
	data->textures.north = mlx_xpm_file_to_image(data->mlx, data->map->north_texture, 
												width, height);
...
{
	data->textures.south = mlx_xpm_file_to_image(data->mlx, data->map->south_texture, 
												width, height);
...
{
	data->textures.west = mlx_xpm_file_to_image(data->mlx, data->map->west_texture, 
												width, height);
...
{
	data->textures.east = mlx_xpm_file_to_image(data->mlx, data->map->east_texture, 
												width, height);
